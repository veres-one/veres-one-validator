...
// FIXME: determine how to use multicodec tool here after multibase.decode
function _getPublicKeyFromId({publicKeyId}) {
  ...
  // drops 0x30ed being added in did-veres-one fingerprint operation
  const pubkeyBytes = mcPubkeyBytes.slice(2);
