...
// TODO: in testnet v2, the ledger `write` proof on the operation
...
module.exports = async ({basisBlockHeight, ledgerNode, validatorInput}) => {
  ...
  // FIXME when verifying the ledger write proof
  // use a proof similar to webLedgerConfiguration's proof with
  // targetAttentuation
