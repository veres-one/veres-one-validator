...
async function _validateProofs({basisBlockHeight, ledgerNode, validatorInput}) {
  ...
  const documentLoader = _createDidDocumentLoader(
...
function _createDidDocumentLoader({basisBlockHeight, ledgerNode, record}) {
